...
namespace DynamicShading
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            gw.DrawString("cmsoft@cmsoft.com.br", f, Brushes.Black, 0, 32);
        ...
        {
            ColorDialog cd = new ColorDialog();
            cd.Color = picStrokeColor.BackColor;
            if (cd.ShowDialog() == DialogResult.OK)
            {
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (curFile != "")
            {
                ...
                sfd.FileName = fi.Name.Split('.')[0] + "render.png";
            }
        ...
        private void saveImageWithStrokesToolStripMenuItem_Click(object sender, EventArgs e)
        {
